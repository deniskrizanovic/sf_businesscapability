...
> Tested by: diagram.spec.ts — "ArrowRight pan -> L2 transform translateX increases (no clip on right)"
...
Given a capability with bcm_HideFromDiagram\_\_c = true  
...
Given an L1 capability with bcm_HideFromDiagram\_\_c = true and L2 children  
