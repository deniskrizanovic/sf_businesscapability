...
|---|---|---|---|---|
| `BCM_L1_FILL` | `#f7f7f7` | 247, 247, 247 | L1 polygon fill | `--bcm-l1-fill` |
| `BCM_L1_FILL_FOCUSED` | `#f7f7f7` | 247, 247, 247 | L1 polygon fill (focused) | `--bcm-l1-fill-focused` |
...
| Token | Hex/Value | RGB | Surface | CSS custom property |
|---|---|---|---|---|
| `BCM_L2_SURFACE` | `#f0f0f0` | 240, 240, 240 | L2 rect fill | `--bcm-l2-surface` |
| `BCM_L2_SURFACE_FOCUSED` | `#f0f0f0` | 240, 240, 240 | L2 rect fill (focused) | `--bcm-l2-surface-focused` |
...
| `BCM_BAND_DIVIDER` | `#c0c0c0` | 192, 192, 192 | Band hairline divider | `--bcm-band-divider` |
...
|---|---|---|---|---|---|
| L1 fill | `#f7f7f7` | `#0070D2` | ~4.7:1 | ✅ Pass | ✅ Pass |
| L2 surface | `#f0f0f0` | `#0070D2` | ~4.8:1 | ✅ Pass | ✅ Pass |
...
**Divider:** Optional hairline stroke between bands: `BCM_BAND_DIVIDER = #c0c0c0` (RGB 192, 192, 192).
