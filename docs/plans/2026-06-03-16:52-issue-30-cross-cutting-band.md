...
4. `_l1Roots` continues to mean _regular_ L1 roots (drives `canvasWidth` for the column area) — keyboard nav state (`_colMap`, `_l2ByCol`) is unaffected because cc L1s are absent from those maps.
