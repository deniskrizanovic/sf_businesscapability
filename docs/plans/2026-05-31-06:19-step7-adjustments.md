...
- Add `bcm_Visualisation` to navItems, second slot (after bcm_Map**c, before bcm_Capability**c)
...
- bcm_Map\_\_c record page has no "Visualisation" action button (only Edit, Delete, Import)
